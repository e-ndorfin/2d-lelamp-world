...
// Proximity-based system constants
export const PROXIMITY_RADIUS = 4; // tiles — agents can see/hear within this
export const REACTION_COOLDOWN = 3000; // ms between event-triggered reactions
export const DECIDE_ACTION_COOLDOWN = 10000; // ms between autonomous polling decisions
export const MAX_CONVERSATION_PARTICIPANTS = 5;

// How many human players can be in a world at once.
export const MAX_HUMAN_PLAYERS = 8;

// Don't talk to anyone for 5s after having a conversation.
